module github.com/yourusername/go-event-order-processor/services/payment-worker
...
require (
	...
	github.com/yourusername/go-event-order-processor/pkg/idempotency v0.0.0
...
replace github.com/yourusername/go-event-order-processor/pkg/idempotency => ../../pkg/idempotency
